    ...
    <section class="text-gray-600 body-font">
        <div class="container px-5 py-24 mx-auto">
            <div class="flex flex-col justify-center items-center ">
                <div class="text-xl md:text-3xl text-orange-500 font-bold uppercase">Our Allumini</div>
            ...
            <div class=" px-8 flex flex-wrap -m-4">
                ...
                <!-- <div class="px-4 pt-20 pb-6 w-full md:w-1 ">
                    <div class="pd-4 bg-slate-200 shadow-lg flex flex-col justify-center items-center px-4 py-4 h-64 w-full md:w-2/3 lg:w-auto">
                        ...
                        <p class="text-center text-sm p-5">Assistant Professor in Chemistry <br> <a class="text-blue-800 font-semibold" href="#">More Info</a> </p>
